(() => {
          ...
          var g = function (a, o, s) {
              ...
              return (
                ...
                (function (a, o, s) {
                  ...
                  function w(a) {
                    var t = a - l;
                    return void 0 === l || t >= o || t < 0 || (g && a - c >= e);
                  }
                  function x() {
                    var a = b();
                    if (w(a)) return k(a);
                    r = setTimeout(
                      ...
                      (function (a) {
                        var t = o - (a - l);
                        return g ? m(t, e - (a - c)) : t;
                      })(a)
                    );
                  }
                  function k(a) {
                    return (r = void 0), v && d ? h(a) : ((d = n = void 0), i);
                  }
                  function j() {
                    var a = b(),
                      t = w(a);
                    if (((d = arguments), (n = this), (l = a), t)) {
                      ...
                      if (g) return (r = setTimeout(x, o)), h(l);
                    }
                  ...
                  return (
                    ...
                    p(s) &&
                      ((u = !!s.leading),
                      (e = (g = 'maxWait' in s) ? y(f(s.maxWait) || 0, o) : e),
          ...
          var $ = function () {
            ...
            H = function (a, t) {
              var o = window.document,
                s = new (_())(M);
              (S = t), s.observe(o.documentElement, { childList: !0, subtree: !0, removedNodes: !0 });
            },
            P = (function () {
              function a(a, t) {
                ...
                P(a, [
                  {
                    ...
                    value: function () {
                      var a = X();
                      return !(!D.test(a) && !Y.test(a.substr(0, 4)));
                    },
                  },
                  {
                    key: 'mobile',
                    value: function () {
                      var a = X();
                      return !(!B.test(a) && !Z.test(a.substr(0, 4)));
                    },
                  },
                  {
                    key: 'tablet',
          ...
          return {
            init: function (a) {
              return (
                ...
                aa.disableMutationObserver || H('[data-aos]', sa),
                na(aa.disable) || ta()
                  ? da()
                  : (document.querySelector('body').setAttribute('data-aos-easing', aa.easing),
                    ...
                    'DOMContentLoaded' === aa.startEvent &&
                      ...
                      oa(!0),
                    window.addEventListener('resize', L(oa, aa.debounceDelay, !0)),
                    window.addEventListener('orientationchange', L(oa, aa.debounceDelay, !0)),
                    K)
              );
            },
            refresh: oa,
  ...
  (o.n = (a) => {
    ...
    (() => {
      ...
      const g = o.p + '859e7011908b0f12bcdf.png',
        v = o.p + '70b678a823ea66b2f2d7.png',
      ...
      (function () {
        ...
        const a = document.getElementById('navLinks').getElementsByTagName('li');
        for (let t = 0; t < a.length; t++) {
          const o = a[t].getElementsByTagName('a');
          k.includes(o[0].getAttribute('id').slice(2)) &&
            (o[0].classList.toggle('text-brand-primary'), o[0].classList.toggle('menuActive'));
        }
      })(),
        (function () {
          const a = window.location.pathname;
          if ('/index.html' === a || '/' === a || '/pages/activities.html' === a) {
