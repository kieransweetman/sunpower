  ...
  (e.m = t),
    ...
    (() => {
      ...
      (function () {
        ...
        (function () {
          const t = window.location.pathname;
          '/pages/map.html' === t && console.log(t);
          let a = [
          ...
          const e = P().map('map').setView([43.610769, 3.876716], 12);
          P()
            ...
            .addTo(e);
          const n = P().icon({ iconUrl: k, shadowUrl: M });
          for (let t = 0; t < a.length; t++) {
            let o = new (P().marker)([a[t][1], a[t][2]], { icon: n }).bindPopup(a[t][0]);
            o.addTo(e), console.log(o);
          }
        })();
    })();
})();
